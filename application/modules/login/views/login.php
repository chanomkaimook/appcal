                                        ...
                                        <form class="form-horizontal" id="login">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" id="username" name="username" class="form-control" placeholder="ชื่อผู้ใช้" value="madmin" required autocomplete="true">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-12">
                                                    ...
                                                    <input type="password" id="password" name="password" class="form-control" value="1234" placeholder="รหัสผ่าน" required autocomplete="true">
